...
/*!
	\defgroup	L3G4200D_REGISTERS		All necessary registers of an L3G4200D
	@{
...
/*!
	\fn			uint8_t l3g4200dSetReg( uint8_t addr, uint8_t reg, uint8_t val )
	\brief		Set the value of a specified register
	\param		addr
	\brief		Address of the L3G4200D
	\param		reg
	\brief		Address of the register (see L3G4200D_REGISTERS)
	\param		val
	\brief		Value for the register
	\return		uint8_t
	\retval     true
	\brief		Success
	\retval     false
